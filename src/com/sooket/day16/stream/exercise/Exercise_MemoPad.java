...
public class Exercise_MemoPad {
		...
		// src/com/sooket/day15/stream/exercise
		
	public static void main(String[] args) {
		Scanner sc = new Scanner(System.in);
		System.out.print("저장할 파일 입력 (확장자 제외) : " );
		String fileName = sc.next();
		String destination = "src/com/sooket/day16/stream/exercise/"+fileName+".txt";
...
//			wr.write("6 : exit\n");
			wr.flush();
			wr.close();
			System.out.println("파일 저장이 완료 되었습니다. F5를 눌러 확인해보세요~");
