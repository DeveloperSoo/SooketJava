package com.sooket.day16.stream.exception.exercise;
...
public class ZeroNotDivideException extends RuntimeException{
	 ...
	 * Checked Exception으로 만드려면 Exception 클래스를 상속받게 하고 (안하면 문제가 생길때)
	 * Unchecked Exception으로 만드려면 RuntimeException 클래스를 상속받으면 됨. (강조하고싶을때) 
	 * 
	 */
