package com.sooket.day02.control.condition;
...
public class Exam_If {
	...
	*/
	...
	// 프로그램을 작성하여라.
		...
		System.out.print("정수하나 입력 : ");
		input = sc.nextInt(); // 해당 문장은 무언가를 입력받을때 마다 적어야함
		if(input % 2 == 0) {
		...
		System.out.print("(삼항)정수하나 입력 : ");
		input = sc.nextInt();
		//삼항연산자로 작성해보기
		
//		String result = (input > 0) ? "양" :
//						(input < 0) ? "음" : "0입니다";
		
		String result = (input == 0) ? "0" :((input < 0) ? "음" : "양"); //중첩 삼항연산자, 중첩 if와 유사
