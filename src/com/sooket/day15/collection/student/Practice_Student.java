...
public class Practice_Student {
	...
	//내가 사용한 풀이
//	public void retestScore(List<Student> student) { 
//		List<Student> sList = student;
//		 
//		for(Student std : sList) {
//			double avg = (std.getFirstScore() + std.getSecondScore()) /2.0;
//			if(avg >= 60) {
//				if(std.getFirstScore() < 40) {
//					System.out.println("1차 재시험");			
//				}else if(std.getSecondScore() < 40){
//					System.out.println("2차 재시험");					
//				}else {
//					System.out.println("모두 통과 하셨습니다.");
//				}
//			}else {
//				if(std.getFirstScore() <= 60) {
//					System.out.println("1차 시험 재평가");
//				}
//				if(std.getSecondScore() <= 60) {
