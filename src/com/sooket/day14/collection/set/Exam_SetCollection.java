package com.sooket.day14.collection.set;
...
public class Exam_SetCollection {
	public static void main(String[] args) {
		...
		Set<String> fruitsSet = new HashSet<String>(); //선언 방법
...
//		fruitsSet.add("체리");
		...
		for(String arr : fruitsArrs) { // for~each 문으로 사용해서 set에 배열값 넣고 출력
			fruitsSet.add(arr);
		}
